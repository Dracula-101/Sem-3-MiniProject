...
public class TicTacToe implements ActionListener {
	...
	boolean user_turn, gameover = false;
	int winposition;
	...
	public boolean checkhorizontalwin(String a) {

		for (int base = 0; base < 7; base += 3) {
			if ((buttons[base].getText() == a) && (buttons[base + 1].getText() == a)
					&& (buttons[base + 2].getText() == "")) {
				winposition = base + 2;
				return true;

			}
			if ((buttons[base].getText() == a) && (buttons[base + 1].getText() == "")
					&& (buttons[base + 2].getText() == a)) {
				winposition = base + 1;
				return true;

			}
			if ((buttons[base].getText() == "") && (buttons[base + 1].getText() == a)
					&& (buttons[base + 2].getText() == a)) {
				winposition = base;
				return true;
	...
	public boolean checkverticalwin(String a) {

		for (int base = 0; base < 3; base++) {
			if ((buttons[base].getText() == a) && (buttons[base + 3].getText() == a)
					&& (buttons[base + 6].getText() == "")) {
				winposition = base + 6;
				return true;

			}
			if ((buttons[base].getText() == a) && (buttons[base + 3].getText() == "")
					&& (buttons[base + 6].getText() == a)) {
				winposition = base + 3;
				return true;

			}
			if ((buttons[base].getText() == "") && (buttons[base + 3].getText() == a)
					&& (buttons[base + 6].getText() == a)) {
				winposition = base;
				return true;
